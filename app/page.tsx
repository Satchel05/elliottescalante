...
export default function Home() {
  return (
    <main className="min-h-screen">
      ...
      <section className="px-4 py-16">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            Hey! I'm Elliott, a software developer at UC Irvine who loves building products for the web from start to finish. 
            <br/>
            <br/>
            I’m looking for summer internships at companies that pay close attention to excellence in their craft and investment in their interns.
          </p>
        </div>
      </section>
      </section>
      ...
      {/* PROJECTS SECTION */}
      <section id="projects" className="px-4 py-16 min-h-screen flex flex-col justify-center items-center">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <Card className="overflow-hidden p-0 hover:shadow-lg transition-shadow">
              ...
              <CardContent className="p-6 space-y-4">
                {/* Title */}
                <div>
                  <h3 className="text-xl font-bold mb-1">Commit The Change x CLCHC</h3>
                  <p className="text-muted-foreground">
                    Quota tracking platform supporting 30+ hospital practitioners
                  </p>
                </div>
                ...
                <div className="flex gap-2 pt-2">
                  ...
                  <Button size="sm" asChild>
                    <a href="https://ctc-uci.com/about" target="_blank">
                      <ExternalLink className="mr-2 h-4 w-4" />
                      About Commit The Change
                    </a>
                  </Button>
                </div>
              </CardContent>
            ...
            <Card className="overflow-hidden p-0 hover:shadow-lg transition-shadow">
              ...
              <CardContent className="p-6 space-y-4">
                {/* Title */}
                <div>
                  <h3 className="text-xl font-bold mb-1">Commit The Change x Center Stage Dance Studio</h3>
                  <p className="text-muted-foreground">
                    Platform easing onboarding burden between staff and 100+ students
                  </p>
                </div>
                ...
                <div className="flex gap-2 pt-2">
                  <Button variant="outline" size="sm" asChild>
                    <a href="https://github.com/ctc-uci/Center-Stage" target="_blank">
                      <Github className="mr-2 h-4 w-4" />
                      Code
                    </a>
                  </Button>
                  <Button size="sm" asChild>
                    <a href="https://medium.com/@committhechange.uci/project-overview-center-stage-647aa0458aa5" target="_blank">
                      <ExternalLink className="mr-2 h-4 w-4" />
                      Medium Page
                    </a>
                  </Button>
      ...
      <section className="px-4 py-16 bg-muted/80">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-4">Let's Build Something Dope.</h2>
          <br/>
      ...
      <footer className="px-4 pt-0 pb-6 text-center text-sm text-muted-foreground bg-muted/80">
        <p>Built with Next.js and shadcn/ui • © {new Date().getFullYear()} Elliott Escalante</p>
      </footer>
    </main>
  )
}